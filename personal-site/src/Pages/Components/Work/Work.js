        ...
        <div className='mx-auto'>
                <div className='grid grid-cols-1 my-auto mx-auto laptop:text-left'>
                    ...
                    <div className='justify-center my-auto'>
                        <ArtFeature link={"https://eco-nebulae.vercel.app/"} image={require("../../../Assets/Images/nebulae.png")} title="Nebulae" description="Working with real-time data and The Device by ifmagic.io, I created a piece that highlights the often imperceptible changes in the environment around us over time. This piece was custom-built for and selected as a finalist for the Data is Art competition in Charlottesville and will be on display from April - December 2024 as part of their grand opening. This was an awesome project and I'd like to continue building on this type of real-time data art in the future. This links to a test version of the piece, the real one requires a connected sensor to work!" />
