        ...
        <div className='mx-auto'>
                <div className='grid grid-cols-1 my-auto mx-auto laptop:text-left'>
                    ...
                    <div className='justify-center my-auto'>
                        ...
                        <ArtFeature image={require("../../../Assets/Images/hearts.png")} title="Days with K" description="A tracker since my girlfriend and I's first date, adding a heart for each day. The piece manages to tell an extremely personal story with the only true variable being the start-date." link={"https://pcybriwsky.github.io/anni-days/"}/>
                    </div>
                </div>
        </div>
    );
